...
public class ModelEntityFlyingPig extends AgeableListModel<EntityFlyingPig> {
    public static LayerDefinition getTexturedModelData() {
        ...
        modelPartData_HEAD.addOrReplaceChild(PartNames.LEFT_EAR,
                                             CubeListBuilder.create()
                                                            .texOffs(32, 4)
                                                            .addBox(0.0F,
                                                                    0.0F,
        ...
        modelPartData_HEAD.addOrReplaceChild(PartNames.RIGHT_EAR,
                                             CubeListBuilder.create()
                                                            .texOffs(32, 4)
                                                            .mirror(true)
                                                            .addBox(0.0F,
        ...
        modelPartData_HEAD.addOrReplaceChild(PartNames.NOSE,
                                             CubeListBuilder.create()
                                                            .texOffs(32, 0)
        ...
        PartDefinition modelPartData_RW = modelPartData_BODY.addOrReplaceChild(PartNames.RIGHT_WING,
                                                                               CubeListBuilder.create()
                                                                                              .texOffs(36, 10)
                                                                                              .addBox(0.0F,
                                                                                                      0.0F,
        ...
        modelPartData_RW.addOrReplaceChild(PartNames.RIGHT_WING_TIP,
                                           CubeListBuilder.create()
                                                          .texOffs(36, 26)
                                                          .addBox(0.0F,
                                                                  0.0F,
        ...
        PartDefinition modelPartData_LW = modelPartData_BODY.addOrReplaceChild(PartNames.LEFT_WING,
                                                                               CubeListBuilder.create()
                                                                                              .texOffs(36, 10)
                                                                                              .mirror(true)
                                                                                              .addBox(-16.0F,
        ...
        modelPartData_LW.addOrReplaceChild(PartNames.LEFT_WING_TIP,
                                           CubeListBuilder.create()
                                                          .texOffs(36, 26)
                                                          .mirror(true)
                                                          .addBox(-16.0F,
        ...
        modelPartData_BODY.addOrReplaceChild(PartNames.LEFT_LEG,
                                             CubeListBuilder.create()
                                                            .texOffs(0, 48)
                                                            .addBox(0.0F,
                                                                    0.0F,
    ...
    @Override
    public void setupAnim(EntityFlyingPig entity,
                          float limbAngle,
                          float limbDistance,
