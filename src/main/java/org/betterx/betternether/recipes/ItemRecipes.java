...
public class ItemRecipes {
    public static void register() {
        if (itemExists(NetherItems.GLOWSTONE_PILE)) {
            ...
            BNRecipeManager.addCraftingRecipe("bn_glowstone_dust",
                                              "",
                                              shape,
                                              materials,
        ...
        if (itemExists(NetherItems.CINCINNASITE_INGOT) && blockExists(NetherBlocks.CINCINNASITE_CHAIN)) {
            ...
            BNRecipeManager.addCraftingRecipe("cincinnasite_chains",
                                              "",
                                              shape,
                                              materials,
        ...
        if (itemExists(NetherItems.LAPIS_PILE)) {
            ...
            BNRecipeManager.addCraftingRecipe("glowstone_pile_to_dust",
                                              "",
                                              shape,
                                              materials,
        ...
        if (blockExists(NetherBlocks.BLOOMING_VINE)) {
            ...
            BNRecipeManager.addCraftingRecipe("bn_yellow_dye",
                                              "",
                                              new String[]{"#"},
                                              materials,
        ...
        if (blockExists(NetherBlocks.GOLDEN_VINE) && itemExists(NetherItems.GLOWSTONE_PILE)) {
            ...
            BNRecipeManager.addCraftingRecipe("bn_golden_vine",
                                              "",
                                              new String[]{"#"},
                                              materials,
        ...
        if (blockExists(NetherBlocks.WALL_MUSHROOM_BROWN)) {
            ...
            BNRecipeManager.addCraftingRecipe("wall_mushroom_brown_1",
                                              "wall_mushroom",
                                              new String[]{"#"},
                                              materials,
            ...
            BNRecipeManager.addCraftingRecipe("wall_mushroom_brown_2",
                                              "wall_mushroom",
                                              new String[]{"#"},
                                              materials,
                                              new ItemStack(NetherBlocks.WALL_MUSHROOM_BROWN));
        ...
        if (blockExists(NetherBlocks.WALL_MUSHROOM_RED)) {
            ...
            BNRecipeManager.addCraftingRecipe("wall_mushroom_red_1",
                                              "wall_mushroom",
                                              new String[]{"#"},
                                              materials,
            ...
            BNRecipeManager.addCraftingRecipe("wall_mushroom_red_2",
                                              "wall_mushroom",
                                              new String[]{"#"},
                                              materials,
                                              new ItemStack(NetherBlocks.WALL_MUSHROOM_RED));
