...
public class NetherBiomes {
    ...
    public static final BCLBiome BIOME_WART_FOREST = registerNetherBiome(
    ...
    public static final BCLBiome BIOME_MUSHROOM_FOREST = registerNetherBiome(
    ...
    public static final BCLBiome BIOME_SULFURIC_BONE_REEF = registerSubBiome(
            Config.BIOME_SULFURIC_BONE_REEF,
            BIOME_BONE_REEF
    );
    public static final BCLBiome BIOME_POOR_GRASSLANDS = registerSubBiome(
            Config.BIOME_POOR_GRASSLANDS,
            BIOME_GRASSLANDS
    );
    public static final BCLBiome NETHER_SWAMPLAND = registerNetherBiome(Config.NETHER_SWAMPLAND);
    public static final BCLBiome NETHER_SWAMPLAND_TERRACES = registerSubBiome(
    ...
    public static final BCLBiome CRIMSON_GLOWING_WOODS = registerSubBiome(
            Config.CRIMSON_GLOWING_WOODS,
            BiomeAPI.CRIMSON_FOREST_BIOME
    );
    public static final BCLBiome OLD_WARPED_WOODS = registerSubBiome(
            Config.OLD_WARPED_WOODS,
            BiomeAPI.WARPED_FOREST_BIOME
    );
    public static final BCLBiome CRIMSON_PINEWOOD = registerSubBiome(
