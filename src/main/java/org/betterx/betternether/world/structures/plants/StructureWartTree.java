...
public class StructureWartTree extends StructureFuncScatter {
    ...
    private static final Direction[] HORIZONTAL = HorizontalDirectionalBlock.FACING.getPossibleValues()
    ...
    public void grow(ServerLevelAccessor world,
        ...
        if (world.isEmptyBlock(pos.above(1)) && world.isEmptyBlock(pos.above(2))) {
            if (world.isEmptyBlock(pos.above(2).north()) && world.isEmptyBlock(pos.above(2)
                                                                                  .south()) && world.isEmptyBlock(pos.above(
                    2).east()) && world.isEmptyBlock(pos.above(2).west()))
                if (world.isEmptyBlock(pos.above(3).north(2)) && world.isEmptyBlock(pos.above(3)
                                                                                       .south(2)) && world.isEmptyBlock(
                        pos.above(3).east(2)) && world.isEmptyBlock(pos.above(3).west(2))) {
