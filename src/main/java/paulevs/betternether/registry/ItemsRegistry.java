...
public class ItemsRegistry
{
	...
	public static final Item SPAWN_EGG_JELLYFISH = registerItem("spawn_egg_hydrogen_jellyfish", makeEgg(EntityRegistry.HYDROGEN_JELLYFISH, color(60, 60, 60), color(200, 200, 200)));
