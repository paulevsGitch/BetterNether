...
public class BlocksRegistry
{
	...
	public static final Block RUBEUS_LOG = registerBlock("rubeus_log", new BlockRubeusLog(STRIPED_LOG_RUBEUS));
	public static final Block RUBEUS_BARK = registerBlock("rubeus_bark", new BlockRubeusLog(STRIPED_BARK_RUBEUS));
