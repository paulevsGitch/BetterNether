...
public class BlocksRegistry
{
	...
	public static final Block CINCINNASITE_POT = registerBlock("cincinnasite_pot", new BlockBNPot());
	public static final Block BRICK_POT = registerBlock("brick_pot", new BlockBNPot());
