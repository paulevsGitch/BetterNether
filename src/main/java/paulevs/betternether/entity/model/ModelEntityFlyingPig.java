...
public class ModelEntityFlyingPig extends AgeableListModel<EntityFlyingPig> {
	public static LayerDefinition getTexturedModelData() {
		...
		modelPartData_HEAD.addOrReplaceChild(PartNames.LEFT_EAR, CubeListBuilder.create()
				.texOffs(32, 4)
				.addBox(0.0F, 0.0F, 0.0F, 5.0F, 5.0F, 1.0F), PartPose.offset(-7.0F, -7.0F, -2.0F));
		...
		modelPartData_HEAD.addOrReplaceChild(PartNames.RIGHT_EAR, CubeListBuilder.create()
				.texOffs(32, 4)
				.mirror(true)
				.addBox(0.0F, 0.0F, 0.0F, 5.0F, 5.0F, 1.0F), PartPose.offset(2.0F, -7.0F, -2.0F));
		...
		modelPartData_HEAD.addOrReplaceChild(PartNames.NOSE, CubeListBuilder.create()
				.texOffs(32, 0)
				.addBox(0.0F, 0.0F, 0.0F, 4.0F, 3.0F, 1.0F), PartPose.offset(-2.0F, -1.0F, -5.0F));
		...
		PartDefinition modelPartData_BODY = modelPartData.addOrReplaceChild(PartNames.BODY, CubeListBuilder.create()
				.texOffs(0, 16)
				.addBox(-5.0F, 3.0F, -4.0F, 10.0F, 14.0F, 8.0F), PartPose.ZERO);
		/*this.body = new ModelPart(this, 0, 16);
		this.body.addCuboid(-5.0F, 3.0F, -4.0F, 10.0F, 14.0F, 8.0F);*/

		PartDefinition modelPartData_RW = modelPartData_BODY.addOrReplaceChild(PartNames.RIGHT_WING, CubeListBuilder.create()
				.texOffs(36, 10)
				.addBox(0.0F, 0.0F, 0.0F, 16.0F, 16.0F, 0.0F), PartPose.offset(5, 2.5F, 0));
		...
		modelPartData_RW.addOrReplaceChild(PartNames.RIGHT_WING_TIP, CubeListBuilder.create()
				.texOffs(36, 26)
				.addBox(0.0F, 0.0F, 0.0F, 16.0F, 16.0F, 0.0F), PartPose.offset(16.0F, 0.0F, 0.0F));
		...
		PartDefinition modelPartData_LW = modelPartData_BODY.addOrReplaceChild(PartNames.LEFT_WING, CubeListBuilder.create()
				.texOffs(36, 10)
				.mirror(true)
				.addBox(-16.0F, 0.0F, 0.0F, 16.0F, 16.0F, 0.0F), PartPose.offset(-5, 2.5F, 0));
		...
		modelPartData_LW.addOrReplaceChild(PartNames.LEFT_WING_TIP, CubeListBuilder.create()
				.texOffs(36, 26)
				.mirror(true)
				.addBox(-16.0F, 0.0F, 0.0F, 16.0F, 16.0F, 0.0F), PartPose.offset(-16.0F, 0.0F, 0.0F));
		...
		modelPartData_BODY.addOrReplaceChild(PartNames.TAIL, CubeListBuilder.create()
				.texOffs(0, 40)
				.addBox(-4.0F, 0.0F, 0.0F, 8.0F, 8.0F, 0.0F), PartPose.offset(0, 17, 0));
		/*tail = new ModelPart(this, 0, 40);
		tail.setPivot(0, 17, 0);
		tail.addCuboid(-4.0F, 0.0F, 0.0F, 8.0F, 8.0F, 0.0F);
		this.body.addChild(tail);*/

		modelPartData_BODY.addOrReplaceChild(PartNames.RIGHT_LEG, CubeListBuilder.create()
				.texOffs(0, 48)
				.addBox(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F), PartPose.offset(1.5F, 15, -4));
		...
		modelPartData_BODY.addOrReplaceChild(PartNames.LEFT_LEG, CubeListBuilder.create()
				.texOffs(0, 48)
				.addBox(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F), PartPose.offset(-4.5F, 15, -4));
