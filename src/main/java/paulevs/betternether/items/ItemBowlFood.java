...
public class ItemBowlFood extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		if (context.getPlayer().isShiftKeyDown() && world.isEmptyBlock(pos) && NetherBlocks.STALAGNATE_BOWL.canSurvive(world.getBlockState(pos), world, pos)) {
			if (!world.isClientSide()) {
				BlockState state = NetherBlocks.STALAGNATE_BOWL.defaultBlockState().setValue(BlockStalagnateBowl.FOOD, bowlFood);
