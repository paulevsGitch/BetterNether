...
public class BNItemMaterials {
	...
	public static final Tier CINCINNASITE_TOOLS = new BNToolMaterial(512, 6F, 2, 14, 2.5F, NetherItems.CINCINNASITE_INGOT);
	public static final Tier CINCINNASITE_DIAMOND_TOOLS = new BNToolMaterial(1800, 8F, 3, 22, 3.5F, Items.DIAMOND);

	public static final Tier NETHER_RUBY_TOOLS = new BNToolMaterial(1300, 4F, 3, 9, 2.0F, NetherItems.NETHER_RUBY);
}
